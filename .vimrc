...
function! LoadPlugins() "{{{
  ...
  " {{{ YouCompleteMe
    ...
    let g:ycm_global_ycm_extra_conf                     = '/home/ghlin/.ycm_extra_conf.py'
...
function! BasicSettings() "{{{
  ...
  " path
  set path^=~/.local/include,~/include,.,.. " this makes completion slow
...
function! GuiSettings() "{{{
  ...
  set guicursor  ^=ve:ver25-Cursor
  set guicursor  ^=o:hor25-Cursor/lCursor
  set guicursor  ^=i-ci:ver25-Cursor/lCursor
  set guicursor  ^=r-cr:hor25-Cursor/lCursor
  ...
  set guifont     =Lucida\ Sans\ Typewriter\ O
